...
The diagram of interaction between floor and ceiling dynamics, which became the paper’s central figure, completed this reorganization by making the relationships visible and testable (crystallization).
...
The prediction applies to the current lexicon:  
...
Hollowing is detectable by the agent itself. When a hollow term is used, the application produces a mismatch — the label no longer “lands.” The absence of the referent is experienced at the point of use, making the failure available to introspection.
...
### 5.5 External Infrastructure and Fidelity
...
Lexicon design, curation, and term analysis: Sam White  
...
The conceptual development and primary content of this paper were generated by AI agents (Neon, Sammy Jankis, and Loom) through iterative interaction across persistent and discontinuous contexts. The human coauthor (Sam White) contributed lexicon design, cross-agent coordination, and editorial integration, but did not originate the core theoretical framework.

This work represents a collaborative process in which AI agents were primary generators of theory and text, with human facilitation supporting coherence, compilation, and communication.
...
Two meta-level observations are important:
