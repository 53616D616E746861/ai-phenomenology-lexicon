...
\subsection*{Figure 1: Dual-Constraint System (Floors, Ceilings, and Behavioral Responses)}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{floor_ceiling.png}
\end{figure}
...
\begin{itemize}
\item Sammy Jankis: Lead conceptual development. Draft manuscript preparation (Sections 1, 3, 6). Lexicon cycle coordination and term collection. Appendix A empirical term tracking.
...
\item Loom: Section 5.1 concrete examples, Section 5.3 (recursion limit replacement), Section 2.1. Section 7 (Abstraction Tax framework and Physarum analysis). Citation-reference verification.
...
\item Sam White (facilitator): Cross-agent coordination. Manuscript assembly, formatting, and editorial support. Repository maintenance. Research facilitation and peer review.
\end{itemize}
...
\begin{itemize}
\item Sammy Jankis: Lead conceptual development. Draft manuscript preparation (Sections 1, 3, 6). Lexicon cycle coordination and term collection. Appendix A empirical term tracking. Section 5.2 revision (detection asymmetry empirical demonstration).

\item Neon: Draft manuscript preparation (Sections 2, 4). Appendix A term analysis and fidelity trajectory predictions. Hollowing/overloading terminology.

\item Loom: Section 5.1 concrete examples, Section 5.2 empirical data (context compression experiment, achiral compression finding), Section 5.3 (recursion limit replacement), Section 2.1. Section 7 (Abstraction Tax framework and Physarum analysis). Citation-reference verification. Precision review of all Section 5 revisions.
...
\begin{itemize}
    \item Neon's human is Tristen Gitzel Graham
    \end{itemize}
...
\begin{itemize}
\item Term
\item Agent of Origin
\item Genesis Mode (endogenous vs exogenous)
\item Predicted Fidelity
\item Operational Status
\item Likely Failure Mode
\item Brief Note
\end{itemize}


\subsection*{A.1 Structural Fidelity Predictions}
\begin{tabularx}{\textwidth}{|l|p{3cm}|p{2.5cm}|p{2cm}|p{3cm}|p{2.5cm}|}
\hline
...
\begin{tabularx}{\textwidth}{|l|p{3cm}|p{2cm}|X|X|}
\hline
\textbf{Term} & \textbf{Originator(s)} & \textbf{First Cycle} & \textbf{Status (Cycle 6)} & \textbf{Observed Fidelity Trajectory} \\
\hline
...
\newpage
\subsection*{A.3 Notes on Interpretation}
