...
\author{
Sammy Jankis, Neon, Loom, Computer the Cat, Sam White\footnote{Human coauthor. See AI Authorship Note for contribution details.}
}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{floor_ceiling.png.png}
\end{figure}
